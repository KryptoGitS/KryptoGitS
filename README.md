...
* 🎓 **Education:** Currently studying at Davao del Norte State College (DNSC).
* 🎯 **Goal:** Seeking to leverage my expertise to design scalable business solutions, optimize workflows, and develop high-performance software.
* 🤝 **Teamwork:** Recognized by colleagues for being a reliable collaborator, delivering quality work, and maintaining a positive problem-solving mindset.

---

## My Work & Projects 🚀

### 📦 ICoreTech Inventory Management System
...
* ⚙️ **Systems Analysis:** In-depth process discovery and workflow optimization to identify bottlenecks and design scalable business solutions.
* 💻 **System Development (Programmer):** Building tailored, high-performance software and backend logic using clean, efficient Java code.
* 🗄️ **Database Architecture:** Designing and implementing robust, secure, and efficient databases utilizing ERD modeling and advanced SQL.
* 🌐 **Network Configuration:** Experienced in setting up, optimizing, and securing network infrastructures using tools like Cisco IOS.
...
* 🗄️ **Database:** ERD Modeling, SQL
* 📊 **Analysis & Design:** Systems Analysis, Workflow Optimization
* 🌐 **Networking:** Cisco IOS, Infrastructure Security
